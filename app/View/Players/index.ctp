<div class="players index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('thLevel'); ?></th>
			<th><?php echo $this->Paginator->sort('playLevel'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($player['Player']['mapOrder']); ?>&nbsp;</td>
		<td><?php echo h($player['Player']['name']); ?>&nbsp;</td>
		<td><?php echo h($player['Player']['thLevel']); ?>&nbsp;</td>
		<td><?php echo h($player['Player']['playLevel']); ?>&nbsp;</td>
		<td><?php echo h($player['Player']['trophies']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($player['Clan']['name'], array('controller' => 'clans', 'action' => 'view', $player['Clan']['id'])); ?>
		</td>
		<td><?php echo h($player['Player']['imageUrl']); ?>&nbsp;</td>
		<td><?php echo h($player['Player']['note']); ?>&nbsp;</td>
